...
Create two alignments, so we can test DiffLogo as well as single logo plots. 

NOTICE that in `aa_aln_1`, second position is always F, in `aa_aln_2` it's always G. This is how we'll know whether the plot is correct or not.
